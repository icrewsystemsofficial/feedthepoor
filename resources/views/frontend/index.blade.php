        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card alpha-container text-white border-0 overflow-hidden mt-2 hover-shadow-theme">
                        <a href="#" target="_blank">
                            <div id="hero-section-image-container" class="card-img-bg"
                                style="background-image: url('https://images.milaap.org/milaap/image/upload/v1590737431/production/images/uploader_images/IMG-20200426-WA0015_1590737429.jpg?format=jpg&mode=max&width=1170');">
                            </div>
                ...
                <div class="col-lg-8 col-md-6 p-5 col-sm-12">
                    ...
                    <br>
                    <small class="text-light-gray">* This data was automatically updated at 00:00
                        {{ now()->subDay(1)->format('d F, Y') }}.</small>
                ...
                <div class="col-12 text-center">
                    <h2 class="display-4">
                        ...
                        <span class="display-6">
                            We're on a mission to make <span class="fst-italic">India hunger-free</span>. Currently
                            present in <span class="text-theme">{{ App\Helpers\LocationHelper::getTotalLocations() }}
                                locations</span> across the country.
                        </span>
                    </h2>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 mb-5 text-center">
                    <h3 class="">
                        What all could you <span class="text-theme">donate</span> to?
                    </h3>
                    <small>
                        We facilitate donations in <strong>{{ count($all_causes) }} causes</strong>, and 80G tax benifit is
                ...
                @php
                    $occurance = 0;
                @endphp
                @forelse ($all_causes as $cause)
                    @if($occurance == 3)
                        <div class="row">
                    @endif
                        <div class="col-md-4">
                            <a class="card btn-hover mb-5" style="height: 150px;" href="{{ route('frontend.donate') }}">
                                <div class="card-body">
                                    <div class="d-flex z-1000">
                                        <div class="media-body d-block">
                                            <span class="h5">
                                                Donate <span class="text-theme">{{ $cause->name }}</span></span>
                                            <span class="fas fa-{{ $cause->icon }} opacity-5"></span>
                                            <div class="text-gray mt-2">
                                                <small>
                                                    <strong>₹{{ number_format($cause->per_unit_cost) }}</strong> per unit cost.
                                                    <br>
                                                    <strong>{{ App\Helpers\DonationsHelper::getTotalDonationsForCause($cause) }}</strong> total recorded donations.
                                                </small>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="col-md-12 mb-5 text-center">
                <small>
                    Click on a cause, and you'll be directed to the donations page.
                </small>
            </div>
...
@section('old')
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="text-left pt-lg-md">
                        <h2 class="heading h1 mb-2">
                            ...
                            <span data-toggle="tooltip" data-placement="top" title=""
                                data-original-title="{{ strtolower(date('d-m-Y', strtotime('yesterday'))) }}">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card bg-dark alpha-container text-white border-0 overflow-hidden">
                        <a href="#" target="_blank">
                            <div id="hero-section-image-container" class="card-img-bg"
                                style="background-image: url('https://cdn.discordapp.com/attachments/694578470772146237/744472703897174036/icrew_feeding_the_poor_5.jpg');">
                            </div>
                            {{-- The soul purpose of this container is to preload the images. Don't remove it. --}}
                            <img id="hidden-image-for-preload" src="null" style="display: none;" />
    ...
    <div>
        ...
        <svg height="100%" width="100%" id="svg" viewBox="0 0 1440 400" xmlns="http://www.w3.org/2000/svg"
            ...
            <path
                d="M 0,400 C 0,400 0,300 0,300 C 71.36923076923077,316.4153846153846 142.73846153846154,332.83076923076925 216,332 C 289.26153846153846,331.16923076923075 364.4153846153846,313.0923076923077 458,305 C 551.5846153846154,296.9076923076923 663.6,298.8 756,293 C 848.4,287.2 921.1846153846154,273.70769230769235 983,272 C 1044.8153846153846,270.29230769230765 1095.6615384615384,280.36923076923074 1170,287 C 1244.3384615384616,293.63076923076926 1342.1692307692308,296.81538461538463 1440,300 C 1440,300 1440,400 1440,400 Z"
                stroke="none" stroke-width="0" fill="url(#gradient)"
                class="transition-all duration-300 ease-in-out delay-150"></path>
        </svg>
    ...
    <section class="slice-lg">
        <div class="container">
            <div class="row row-grid justify-content-around align-items-center">
                <div class="col-md-10">
                    <h1 class="heading h2">How does it <span
                            class="font-weight-700 text-underline font-italic">work</span>?</h1>
                    <p>
                        Getting "proof" for donations have always been a herculean task. We've managed to simplify it using
                    ...
                    <div class="card z-depth-3">
                        <div class="card-body">
                            <div id="step1-p" class="animate__animated animate__fadeIn" style="display: none;">
                                ...
                                You donate to our NGO partner via Razorpay payment gateway. The payment is automatically
                                verified and accepted by our website. We immediately place the order for the food to donate
                                the next day. You will recieve a recipt within the next 5 - 10 minutes.
                            </div>
                            <div id="step2-p" class="animate__animated animate__fadeIn" style="display: none;">
                                <h3 class="h3">We distribute the food </h3>
                                With the help of our Voulenteers, we distribute the food which was arranged by your donation
                                to the underprivileged people in certain locations.
                            </div>
                            <div id="step3-p" class="animate__animated animate__fadeIn" style="display: block;">
                                <h3 class="h3">You get happy pictures</h3>
                                While we distribute the food, we take a quick moment to click a picture of your donation,
                                along with your name with the person who is receiving it and mail it to you. We post the
                                same
                                on our NGO partner's instagram account. If you have provided instagram handle, we'll tag
                                you.
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-grid justify-content-around align-items-center">
                <div class="card hover-shadow-lg hover-scale-110 order-2 col-lg-6">
                    <div class="card-body p-5">
                        ...
                        <p class="h4 lh-150">
                            India is home to the largest <span class="font-italic font-weight-700">undernourished</span>
                        ...
                        <br /><br /><br />
                        There are always people who strive to help. There are people who deep down "want" to help, but
                        they're
                ...
                <div class="col-lg-6">
                    <div class="d-flex">
                        <div class="icon-text">
                            ...
                            The first thing that haunts the mind of every good soul that wants to help, is the doubt, the
                            grey area, and lack of <strong>"Transparency"</strong>
                            <br><br>
                            <h4>Seeing is beliving.</h4>
                            #feedThePoor initiative is all about transparency. With the help of our NGO partners, we are
                            able to show our donors who they've fed, and how every penny of their donation is putting a
                            smile across
        ...
        <div class="container">
            <div class="mb-5 text-center">
                ...
                <div class="fluid-paragraph mt-3">
                    <p class="h4">
                        though, what better advertisement than the <span
                            class="text-underline font-weight-700 font-italic">truth</span>?
                    </p>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-11">
                    <div class="swiper-js-container row align-items-center">
                        <div class="col-xl-4 d-none d-xl-block">
                            <div class="pr-4">
                                <p class="lead mt-3">
                                    Testimonials left by our donors. They love <span
                                        class="font-weight-700">#feedThePoor</span> for a reason.
                                </p>
                            </div>
                        </div>
                        <div class="col-xl-8">
                            <div class="swiper-container swiper-container-initialized swiper-container-horizontal"
                                data-swiper-items="1" data-swiper-space-between="0" data-swiper-sm-items="2"
                                style="cursor: grab;">
                                    ...
                                    <div class="swiper-slide p-4 swiper-slide-active" style="width: 333.5px;">
                                        ...
                                        <div class="card bg-dark">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img alt="Image placeholder" src="https://picsum.photos/200/201"
                                                ...
                                                <p class="mt-4 lh-180">Amazing template! All-in-one, clean code,
                                                    beautiful design, and really not hard to work with.Highly recommended
                                                    for any kind on website.</p>
                                    ...
                                    <div class="swiper-slide p-4 swiper-slide-next" style="width: 333.5px;">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img alt="Image placeholder" src="https://picsum.photos/200/202"
                                                            class="avatar  rounded-circle">
                                                    </div>
                                                    <div class="pl-3">
                                    ...
                                    <div class="swiper-slide p-4" style="width: 333.5px;">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img alt="Image placeholder" src="https://picsum.photos/200/203"
                                                            class="avatar  rounded-circle">
                                                    </div>
                                                    <div class="pl-3">
                            ...
                            <!-- Add Pagination -->
                            <div
                                class="swiper-pagination w-100 pt-4 d-flex align-items-center justify-content-center swiper-pagination-clickable swiper-pagination-bullets">
                ...
                <div class="col-lg-6">
                    <div class="block block-image">
                        <img style="height: auto; width: 100%;"
                            src="https://feedthepoor.online/en/public/images/donate_trandparently.png"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 py-5">
                        ...
                        <div class="C-tab-cont mt-5 tab-content" id="myTabContent">
                            <div class="C-tab-item tab-pane fade active show" id="home" role="tabpanel"
                                ...
                                <center>
                                    <a href="http://feedthepoor.online/en/money"
                            ...
                            <div class="C-tab-item tab-pane fade" id="profile" role="tabpanel"
                                ...
                                <center>
                                    <a href="http://feedthepoor.online/en/coming-soon"
                            ...
                            <div class="C-tab-item tab-pane fade" id="contact" role="tabpanel"
                                ...
                                <center>
                                    <a href="http://feedthepoor.online/en/voulenteer"
                                        class="btn btn-md bg-success text-white btn-animated btn-animated-y">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 pr-5">
                            <img style="height: auto; width: 100%;"
                                src="https://feedthepoor.online/en/public/images/sponsor_a_meal.png"
                                class="img-center img-fluid rounded z-depth-3" alt="">
                        </div>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-md-12">
                                                    ...
                                                    <div id="money-buttons-group">
                                                        <center class="mb-2">
                                                            <button type="button" onclick="updateMoney(100);"
                                                                class="btn btn-success btn-sm">
                                                                ₹100
                                                            </button>

                                                            <button type="button" onclick="updateMoney(250);"
                                                                class="btn btn-success btn-sm ml-0">
                                                                ₹250
                                                            </button>

                                                            <button type="button" onclick="updateMoney(500);"
                                                                class="btn btn-success btn-sm ml-0">
                                                                ₹500
                                                            </button>

                                                            <button type="button" onclick="toggleCustomDonation();"
                                                                class="btn btn-secondary btn-sm ml-0 mt-2 btn-block">
                                                                Enter custom amount
                                                            </button>
                                                    ...
                                                    <script>
                                                        function updateMoney(value) {
                                                            ...
                                                            if (value == '') {
                                                                ...
                                                                if (value < 30) {
                                                                    alert(
                                                                        'Dear donor, it takes us a minimum of ₹30 to feed a person. Please consider a higher amount to continue.')
                                                                }
                                                            }
                                                    ...
                                                    <div class="input-group mb-3" id="customDonationAmountBox"
                                                        style="display: none;">
                                                        <input type="text" class="form-control"
                                                            placeholder="Minimum of ₹30" id="custom-amount">
                                                        <div class="input-group-append">
                                                            <button
                                                                onclick="updateMoney(document.getElementById('custom-amount').value); toggleCustomDonation();"
                                                                class="btn btn-secondary" type="button">Process</button>
                                                        </div>
                                                    </div>
                                   ...
                                   <div class="col-md-2" style="padding: 0px; margin: 0px;">
                                      <a class="btn btn-sm text-dark donate-minus-button btn-secondary">
                                        ...
                                        <button onclick="processNextStep();"
                                            class="btn btn-block btn-lg bg-white mt-4 btn-animated btn-animated-x text-success">
                                            <span class="btn-inner--visible">Proceed to donate ₹<span
                                                    id="donationAmount">50</span></span>
                                            <span class="btn-inner--hidden">
                                                <svg class="svg-inline--fa fa-credit-card fa-w-18" aria-hidden="true"
                                        ...
                                        <p class="mt-3 text-center text-white">
                                            <span id="mealsPossible">1</span> donation(s) possible* ₹<span
                                                id="moneyPossible">50</span>
                                        </p>
                                    </form>
                                </div>
                            </div>
            ...
            <div class="row py-5 align-items-center cols-xs-space cols-sm-space cols-md-space">
                <div class="col-md-12">
                    <div class="campaign custom--card">
                        <div class="wrapper"
                            style="background: url('https://cdn.discordapp.com/attachments/546410461193699334/745487084713672825/mission_daily_meal_website.png') center/cover no-repeat;">
                            ...
                            <div class="data">
                                <div class="content">
                                    ...
                                    <p class="text py-5">This Campaign was launched by icrewsystems to raise donations
                                        to serve daily meals to all the underprivledged</p>
                                    <a href="http://feedthepoor.online/en/mission" class="btn btn-primary btn-sm">Take part
                                        in this campaign</a>
                                </div>
                            </div>
                        </div>
