...
@section('meta')
<title>
    About us | FeedThePoor - Donate money confidently and Transparently
</title>
@endsection
...
<section class="slice-lg">
    <div class="container">
        <div class="row align-items-center cols-xs-space cols-sm-space cols-md-space">
            ...
            <div class="col-lg-6">
                <div>
                    <img style="height: 250px; width: auto;" src="https://cdn.discordapp.com/attachments/530789778912837640/691801343723307068/1585008642050.png" class="img-center img-fluid rounded z-depth-3 z-depth-3" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center cols-xs-space cols-sm-space cols-md-space">
            ...
            <div class="col-lg-6">
                <div class="block block-image">
                    <img style="height: auto; width: 100%;" src="https://cdn.discordapp.com/attachments/741259606512107602/745210139396538438/20200818_144848.jpg" class="img-center img-fluid rounded z-depth-3" alt="">
                </div>
            </div>
    ...
    <div class="container">
        <div class="row align-items-center cols-xs-space cols-sm-space cols-md-space">
          ...
          <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                <div class="block block-image">
                    <img style="height: auto; width: 100%;" src="https://cdn.discordapp.com/attachments/741259606512107602/745210919029702716/20200818_144926.jpg" class="img-center img-fluid rounded z-depth-3" alt="">
                </div>
            </div>
        </div>
    </div>
