        ...
        <div class="col-lg-6">
          <div class="d-flex">
              <div class="icon-text">
                  ...
                  <p>
                      </p><h1>- This is what we are solving</h1>
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-primary">
                            <div class="form-group">
                              <div class="row align-items-center">
                                <div class="col-md-2" style="padding: 0px; margin: 0px;">
                                  <a class="btn btn-sm donate-plus-button text-dark btn-secondary"><svg class="svg-inline--fa fa-plus fa-w-14" aria-hidden="true" data-prefix="fa" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M448 294.2v-76.4c0-13.3-10.7-24-24-24H286.2V56c0-13.3-10.7-24-24-24h-76.4c-13.3 0-24 10.7-24 24v137.8H24c-13.3 0-24 10.7-24 24v76.4c0 13.3 10.7 24 24 24h137.8V456c0 13.3 10.7 24 24 24h76.4c13.3 0 24-10.7 24-24V318.2H424c13.3 0 24-10.7 24-24z"></path></svg><!-- <i class="fa fa-plus"></i> --></a>
                                </div>
                                <div class="col-md-8">
                                  <input type="text" class="form-control donate-meal-display" id="input_email" placeholder="Meals" required="">
                                </div>
                                <div class="col-md-2" style="padding: 0px; margin: 0px;">
                                  <a class="btn btn-sm text-dark donate-minus-button btn-secondary"><svg class="svg-inline--fa fa-minus fa-w-14" aria-hidden="true" data-prefix="fa" data-icon="minus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M424 318.2c13.3 0 24-10.7 24-24v-76.4c0-13.3-10.7-24-24-24H24c-13.3 0-24 10.7-24 24v76.4c0 13.3 10.7 24 24 24h400z"></path></svg><!-- <i class="fa fa-minus"></i> --></a>
                                </div>
                              </div>
                            </div>
                            <button type="submit" class="btn btn-block donate-meal-button btn-lg bg-white mt-4 btn-animated btn-animated-x">
                                ...
                                <span class="btn-inner--hidden"><svg class="svg-inline--fa fa-credit-card fa-w-18" aria-hidden="true" data-prefix="fas" data-icon="credit-card" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg=""><path fill="currentColor" d="M0 432c0 26.5 21.5 48 48 48h480c26.5 0 48-21.5 48-48V256H0v176zm192-68c0-6.6 5.4-12 12-12h136c6.6 0 12 5.4 12 12v40c0 6.6-5.4 12-12 12H204c-6.6 0-12-5.4-12-12v-40zm-128 0c0-6.6 5.4-12 12-12h72c6.6 0 12 5.4 12 12v40c0 6.6-5.4 12-12 12H76c-6.6 0-12-5.4-12-12v-40zM576 80v48H0V80c0-26.5 21.5-48 48-48h480c26.5 0 48 21.5 48 48z"></path></svg><!-- <i class="fas fa-credit-card"></i> --></span>
                            </button>
                        </form>
                    </div>
                </div>
