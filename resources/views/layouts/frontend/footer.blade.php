<footer class="position-relative mt--150px pt-5 pb-3 footer footer-dark bg-tertiary">
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 col-md">
                ...
                <ul class="list-unstyled text-small">
                    <li><a class="text-muted" href="http://feedthepoor.online/en/faq">FAQ</a></li>
                    <li><a class="text-muted" href="http://feedthepoor.online/en/contacts">Contact</a></li>
                </ul>
            </div>
            <div class="col-6 col-md">
        ...
        <div class="d-flex align-items-center">
            <span class="">
                #feedThePoor © 2021 Made with ❤️ by <a href="https://icrewsystems.com/en/" class="footer-link" target="_blank">icrewsystems</a>. All rights
                reserved.
            </span>
        </div>
    </div>
