      ...
      <div class="row align-items-center justify-content-md-between py-4 mt-4 delimiter-top">
        <div class="col-md-6">
          <div class="copyright text-sm font-weight-bold text-center text-md-left">
            #feedThePoor © 2020-{{ date('Y')}}. Made with <i class="fa fa-heart text-danger"></i> by <a href="https://icrewsystems.com/en/?ref={{ config('app.url') }}" class="footer-link" target="_blank">icrewsystems</a>. All rights reserved.
          </div>
        </div>
        <div class="col-md-6">
            <div class="text-sm text-right text-white">
                <i class="fa fa-check-circle text-success"></i> All systems operational
            </div>
        </div>
      </div>
    </div>
