...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <style>
      .sidebar-gradient {
        background: rgb(72,79,84);
        background: -moz-linear-gradient(180deg, rgba(72,79,84,1) 0%, rgba(38,113,175,1) 79%, rgba(0,101,187,1) 100%);
        background: -webkit-linear-gradient(180deg, rgba(72,79,84,1) 0%, rgba(38,113,175,1) 79%, rgba(0,101,187,1) 100%);
        background: linear-gradient(180deg, rgba(72,79,84,1) 0%, rgba(38,113,175,1) 79%, rgba(0,101,187,1) 100%);
        filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#484f54",endColorstr="#0065bb",GradientType=1);
      }
    </style>
    <ul class="navbar-nav sidebar-gradient sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#ReciptsCollapse" aria-expanded="true" aria-controls="ReciptsCollapse">
          <i class="fas fa-fw fa-cog"></i>
          <span>Recipts</span>
        </a>
        <div id="ReciptsCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{ url('admin/') }}">Generate for today</a>
            <a class="collapse-item" href="{{ url('admin/') }}">Create custom recipt</a>
            <a class="collapse-item" href="{{ url('admin/') }}">View all recipts</a>
          </div>
        </div>
      </li>

      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#emailCollapse" aria-expanded="true" aria-controls="emailCollapse">
          <i class="fas fa-fw fa-cog"></i>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ url('admin/') }}">
          <i class="fas fa-fw fa-table"></i>
          <span>Partners Organizations</span></a>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright my-auto">
            <span>{{ env('APP_NAME') }}. Made with <i class="fa fa-heart text-danger"></i> by <a href="https://icrewsystems.com?ref={{ env('APP_URL') }}">icrewsystems</a> in India</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
