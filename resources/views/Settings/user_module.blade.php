...
<div class="row">
    <div class="col-lg-12">
        <a class="btn btn-primary float-right" href="{{ route('user.create.view') }}" >Create User</a>
    </div>
</div>
                    <div class="mb-2">
                                    ...
                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deletemodal"><i class="fas fa-trash-alt"></i> Delete</button>
                                        ...
                                        <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="deletemodal" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                ...
                                                <a class="btn btn-danger" href="{{ "delete/".$item['id'] }}" ><i class="fas fa-trash-alt"></i> Yes, I'm sure</a>
